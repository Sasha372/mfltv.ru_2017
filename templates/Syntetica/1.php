...
<head>
    ...
    <link rel="apple-touch-icon" sizes="57x57" href="/templates/Syntetica/img/favicon/apple-touch-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="/templates/Syntetica/img/favicon/apple-touch-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="/templates/Syntetica/img/favicon/apple-touch-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="/templates/Syntetica/img/favicon/apple-touch-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="/templates/Syntetica/img/favicon/apple-touch-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="/templates/Syntetica/img/favicon/apple-touch-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="/templates/Syntetica/img/favicon/apple-touch-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="/templates/Syntetica/img/favicon/apple-touch-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="/templates/Syntetica/img/favicon/apple-touch-icon-180x180.png">
    <link rel="icon" type="image/png" href="/templates/Syntetica/img/favicon/favicon-32x32.png" sizes="32x32">
    <link rel="icon" type="image/png" href="/templates/Syntetica/img/favicon/favicon-194x194.png" sizes="194x194">
    <link rel="icon" type="image/png" href="/templates/Syntetica/img/favicon/favicon-96x96.png" sizes="96x96">
    <link rel="icon" type="image/png" href="/templates/Syntetica/img/favicon/android-chrome-192x192.png" sizes="192x192">
    <link rel="icon" type="image/png" href="/templates/Syntetica/img/favicon/favicon-16x16.png" sizes="16x16">
    <link rel="manifest" href="/templates/Syntetica/img/favicon/manifest.json">
    <link rel="mask-icon" href="/templates/Syntetica/img/favicon/safari-pinned-tab.svg" color="#5bbad5">
    <link rel="shortcut icon" href="/templates/Syntetica/img/favicon/favicon.ico">
    <meta name="msapplication-TileColor" content="#66e0e5">
    <meta name="msapplication-TileImage" content="/templates/Syntetica/img/favicon/mstile-144x144.png">
    <meta name="msapplication-config" content="/templates/Syntetica/img/favicon/browserconfig.xml">
    <meta name="theme-color" content="#ffffff">
    <!-- end favicon links -->

    <link rel="stylesheet" href="/templates/Syntetica/css/bootstrap.min.css" />
    <link rel="stylesheet" href="/templates/Syntetica/css/normalize.min.css">
    <link rel="stylesheet" href="/templates/Syntetica/css/animate.min.css">
    <link rel="stylesheet" href="/templates/Syntetica/css/flickity.min.css">
    <link rel="stylesheet" href="/templates/Syntetica/css/styles.css">
    <link rel="stylesheet" href="/templates/Syntetica/css/block-news.css"">
...
<div class="container-fluid">
    <div class="row">
        <div class="header-nav-wrapper">
            <div class="logo">
                <a href="/"><img src="/templates/Syntetica/img/mfl-logo.png" alt="MFL TV - Открытая Студия"></a>
            </div>
            <div class="primary-nav-wrapper">
                <nav>
                    <ul class="primary-nav">
                        {if $live }<li><a href="/#intro">Эфир</a></li>{/if}
                        <li><a href="/#guests">Последние участники</a></li>
                        <li><a href="/#ng">Наш Город</a></li>
                        <li><a href="/#events">События</a></li>
                    </ul>
                </nav>
                <div class="secondary-nav-wrapper">
                    <ul class="secondary-nav">
                        <li class="subscribe"><a href="/#join-ng">Подписаться</a></li>
