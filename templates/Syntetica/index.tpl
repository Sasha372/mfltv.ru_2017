	...
	<section class="collective has-padding" id="intro">
		<div class="container">
			<div class="row">
				...
				<a href="/megazin/?path=5" class="col-md-9" target="_blank" style="width: min-content">
					<img src="/uploads/megazins/5/Page/1.jpg" height="600px" width="441px">
				</a>
			</div>
		</div>
		<div class="container">
...
<!-- <h3>{$front_videos.0.list.0.video_title}</h3> -->					
...
<div class="col-md-10">
            ...
            {/if}
					...
					<p>{$front_videos.0.list.0.description}</p>
				</div>
